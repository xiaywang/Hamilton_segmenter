...
#ifndef INC_QRSDET_H_
#define INC_QRSDET_H_
...
#define DERIV_LENGTH	MS10 //4 with sr = 360
#define LPBUFFER_LGTH ((int) (2*MS25)) //18
#define HPBUFFER_LGTH MS125 //45

#define WINDOW_WIDTH	MS80 //203			// Moving window integration width.
