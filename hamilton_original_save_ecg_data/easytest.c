...
#if SAVEFILE
		FILE *fp;
		fp = fopen("./to_plot/ecgdata.csv", "w");
		fprintf(fp, "ecg_data\n");
		fclose(fp);
		fp = fopen("./to_plot/DetectionTime.csv", "w");
		fprintf(fp, "DetectionTime\n");
		fclose(fp);

		// sample counter
		long int counter =0;
		// for the DetectionTime offset
		long int DT_offset=0;
#endif
...
#if SAVEFILE
			fp = fopen("./to_plot/ecgdata.csv", "a+");
			fprintf(fp, "%d\n", ecg[0]);
			fclose(fp);
#endif
...
#if SAVEFILE
				fp = fopen("./to_plot/DetectionTime.csv", "a+");
				fprintf(fp, "%ld\n", DT_offset + DetectionTime);
				fclose(fp);
